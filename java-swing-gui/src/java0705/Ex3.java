...
public class Ex3 extends JFrame {
	...
	private final JLabel lblProfileId_1 = new JLabel("비밀번호");
	...
	private void init() {
		this.tfLoginPasswd.setBounds(131, 101, 127, 21);
...
//	});
	...
	private void setupViewProfile() {
		...
		this.lblProfile.setBounds(81, 24, 165, 52);
		
		this.panel3.add(this.lblProfile);
		this.lblProfileId.setBounds(41, 86, 57, 15);
		
		this.panel3.add(this.lblProfileId);
		this.lblProfileId_1.setBounds(41, 124, 57, 15);
		
		this.panel3.add(this.lblProfileId_1);
