...
public class Ex1 {
	...
	public static void main(String[] args) {
		...
		// InputStream - FileInputStream (BufferedInputStream) <- 괄호는 보조스트림
		// OutpuStream - FileOutputStream(BufferedOutputStream)

		// char : 입출력 char 단위 처리. 텍스트 위주의 데이터 입출력
		...
		int data = 0;
		try {
			data = in.read(); // 바이트 단위 입력 스트림으로 부터 한 바이트 입력받기
