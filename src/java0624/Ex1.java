...
//	}
	...
	public boolean equals(Object obj) { // Object 타입의 자손이면 다 들어올 수 있음
		// instanceof 연산자 : 참조변수가 현재 참조하는 실제 객체의 타입이 Puppy인지 확인 // 다운캐스팅 하기 전에 올바른 객체가
		// 맞는지 확인하는거
		// true/false 리턴
...
public class Ex1 {
	...
	public static void main(String[] args) {
		...
		String str3 = "반가워"; // 리터럴은 메모리를 아끼기 위해 특별한 테이블을 사용함. / 원래 있던 리터럴이면 원래 있던 주소로 가서 그대로 가져와서 씀 // 같을때도
								// 있고 다를때도 있음. 쓰면안됨.
		String str4 = "반가워";
